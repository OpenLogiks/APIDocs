		...
		<div class="col-lg-12">
			...
			<?php } ?>
				...
				<?php
					...
					echo "<div class='nested textContent'>".stripslashes($apiDetails['descs_long'])."</div>";
				?>
				...
				<div class='nested' style='clear:both;height: 175px;border:1px solid #CCC;'>
					...
					<div class="panel panel-default col-sm-6 col-lg-6" style='border:0px;'>
						<table class="table" width=100%>
							<tr><td>Source Path</td><td><?=$apiDetails['src_path']?></td></tr>
